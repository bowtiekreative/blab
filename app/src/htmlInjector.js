...
class HtmlInjector {
    ...
    getInjectData() {
        return {
            ...
            OG_SITE_NAME: this.config?.og?.siteName || 'Hustle Zone',
            OG_TITLE: this.config?.og?.title || 'Click the link to make a call.',
            OG_DESCRIPTION:
                this.config?.og?.description ||
                'Hustle Zone calling provides real-time HD quality and latency simply not available with traditional technology.',
